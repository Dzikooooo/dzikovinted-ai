...
const trends = [
  { name: "Ralph Lauren Zip", price: "45€", sales: "+132%", badge: "🔥 Très demandé" },
  { name: "Nike Shox", price: "95€", sales: "+89%", badge: "📈 Explosion" },
  { name: "Carhartt Detroit", price: "120€", sales: "+61%", badge: "💰 Rentable" },
  { name: "Stüssy Hoodie", price: "80€", sales: "+57%", badge: "⚡ Rapide" },
];
...
export default function Market({
    ...
    <div className="p-8 space-y-8">
      ...
      <div className="bg-[#151515] rounded-2xl border border-white/5">
        <div className="p-6 border-b border-white/5">
          <h2 className="text-2xl font-bold">Produits les plus rentables</h2>
          <p className="text-gray-400">Les meilleures opportunités actuellement.</p>
        </div>
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-gray-500">{item.badge}</div>
                </div>
              </div>
  ...
  className="mt-8 bg-[#39FF14] text-black px-6 py-3 rounded-xl font-bold inline-flex items-center gap-2 hover:scale-105 transition"
>
