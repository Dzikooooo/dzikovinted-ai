  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 max-w-6xl mx-auto">
      ...
      <div>
        ...
        {loading ? (
          <div className="space-y-3">{Array.from({ length: 3 }).map((_, i) => <div key={i} className="h-14 bg-[#181818] rounded-xl animate-pulse" />)}</div>
          ...
          <div className="space-y-2">
            {recentListings.map((l) => (
              <div key={l.id} className="bg-[#181818] border border-white/5 rounded-xl px-4 py-3 flex items-center gap-4 hover:border-white/10 transition-colors group">
                {l.image_urls?.[0] ? (
