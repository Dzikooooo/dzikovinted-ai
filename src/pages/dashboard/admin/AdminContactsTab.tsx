...
import { Ban, CheckCircle2, RotateCcw, Send, Settings2, Trash2, Users, X } from 'lucide-react';
...
// Onglet "Contacts" (refonte Administration en 2 onglets, 2026-08-29) --
// extrait tel quel de l'ancien AdminUsersPage.tsx (demande produit
// 2026-08-04, etendue 2026-08-29 avec renommage + suppression de compte) :
// carnet d'adresses complet des comptes inscrits (profiles.select ouvert
// aux admins depuis la migration 20260804120000), avec toutes les actions
// de gestion (renommer, bloquer/debloquer, modifier le mode credits,
// supprimer, notifier) -- toutes via des RPC SECURITY DEFINER dediees ou
// la fonction Edge delete-account, jamais un update/delete direct sur
// profiles, qui reste verrouille pour authenticated (P0.1, 2026-07-11).
// Le garde-fou admin (useIsAdmin/role) reste dans le composant parent
// (AdminUsersPage.tsx, la coquille a 2 onglets) -- jamais duplique ici.
    ...
    <div>
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between mb-4">
          <SectionLabel>Comptes inscrits</SectionLabel>
          <span className="text-xs text-gray-500">{profiles.length} compte{profiles.length > 1 ? 's' : ''}</span>
        </div>
        <SearchInput
          value={search}
