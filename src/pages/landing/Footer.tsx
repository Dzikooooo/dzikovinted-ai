      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-[15px] text-gray-500">
              <li><button onClick={() => onNavigate('blog')} className="hover:text-[#007782] transition-colors">À propos</button></li>
              <li><button onClick={() => goToSection('features')} className="hover:text-[#007782] transition-colors">Fonctionnalités</button></li>
              <li><button onClick={() => goToSection('pricing')} className="hover:text-[#007782] transition-colors">Tarifs</button></li>
              <li><button onClick={() => onNavigate('newsletter')} className="hover:text-[#007782] transition-colors">Newsletter</button></li>
              <li><button onClick={() => onNavigate('auth')} className="hover:text-[#007782] transition-colors">Connexion</button></li>
            </ul>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-[15px] text-gray-500">
              <li>
                <a href="mailto:resellosapp@gmail.com" className="flex items-center gap-2 hover:opacity-80 transition-opacity" style={{ color: '#007782' }}>
              ...
              <li>
                <a
                  ...
                  className="flex items-center gap-2 hover:text-[#007782] transition-colors"
                >
        ...
        <div className="border-t border-gray-200 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex flex-wrap items-center justify-center gap-x-3 gap-y-1.5 text-xs text-gray-600">
            ...
            <button onClick={openChangelog} className="font-mono hover:opacity-80 transition-opacity" style={{ color: '#007782B3' }}>
              Version bêta
            </button>
            {DISCORD_INVITE_URL && (
              <>
                <span className="hidden sm:inline text-gray-300">·</span>
                <a href={DISCORD_INVITE_URL} target="_blank" rel="noopener noreferrer" className="hover:text-[#007782] transition-colors">
                  Discord
                </a>
              </>
            )}
          ...
          <div className="flex gap-4">
            <a
              ...
              className="text-gray-600 hover:text-[#007782] transition-colors"
            >
