...
export function StatCard({ label, value, highlight, size = 'sm', icon: Icon }: StatCardProps) {
  if (size === 'lg') {
    return (
      <div
      ...
      >
        {Icon && (
          <div className="w-9 h-9 bg-neon-500/10 rounded-xl flex items-center justify-center mb-3">
