...
export function StatCard({ label, value, highlight, size = 'sm' }: StatCardProps) {
  if (size === 'lg') {
    return (
      <div className="bg-surface-alt border border-white/10 rounded-2xl p-5 transition-colors hover:border-white/20">
  ...
  return (
    <div className="bg-surface border border-white/5 rounded-2xl p-4 transition-colors hover:border-white/10">
